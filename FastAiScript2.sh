...
read -p "Azure VM Name (default: fastbagel): " vminput
vmname=${vminput:=fastbagel}
...
az vm create --name $vmname -g $vmname --image microsoft-dsvm:ubuntu-1804:1804:latest  --size Standard_NC6_Promo --storage-sku StandardSSD_LRS --admin-user fastbagel --admin-password $password
...
echo "Login userid is 'fastbagel' with password you entered above"