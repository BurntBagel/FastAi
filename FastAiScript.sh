...
read -p "Azure VM Name (default: fastpotato): " vminput
vmname=${vminput:=fastpotato}
...
# You can find Azure size labels by running Azure CLI command in Cloud Shell "az vm list-sizes -l EastUS -o table"  
