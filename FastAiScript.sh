...
az vm create --name $vmname -g $vmname --image microsoft-dsvm:ubuntu-1804:1804:latest  --size Standard_NC6_Promo --storage-sku StandardSSD_LRS --admin-user fastuser --admin-password $password
